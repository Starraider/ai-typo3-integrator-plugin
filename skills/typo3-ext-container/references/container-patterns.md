...
Confirm Registry, processor, and column-restriction APIs against the installed
`b13/container` version before applying these patterns.
...
Validate the copied XLF with `xmllint` before committing.
